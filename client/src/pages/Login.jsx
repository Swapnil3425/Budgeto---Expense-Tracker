...
import { TrendingUp, Mail, Lock, Eye, EyeOff, Home } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0118', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      ...
      <div style={{ position: 'fixed', top: '10%', right: '10%', width: 500, height: 500, borderRadius: '50%',
        background: 'radial-gradient(circle, rgba(255,119,51,0.07) 0%, transparent 70%)', pointerEvents: 'none' }} />
      <div style={{ position: 'fixed', bottom: '10%', left: '10%', width: 500, height: 500, borderRadius: '50%',
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}
        ...
        <div className="glass" style={{ padding: 32 }}>
          <h1 style={{ fontFamily: 'Poppins', fontWeight: 700, fontSize: 24, marginBottom: 6 }}>Welcome back</h1>
          <p style={{ color: '#9b8cb0', fontSize: 14, marginBottom: 28 }}>Sign in to your Budgeto account</p>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input className="input-field" style={{ paddingLeft: 34, paddingRight: 40 }} type={showPass ? 'text' : 'password'}
                  placeholder="Your password" value={form.password} onChange={e => set('password', e.target.value)} required />
          ...
          <p style={{ textAlign: 'center', fontSize: 13, color: '#9b8cb0', marginTop: 20 }}>
            ...
            <Link to="/register" style={{ color: '#FF7733', textDecoration: 'none', fontWeight: 600 }}>Sign up free</Link>
          </p>
        </div>
      </motion.div>
    </div>
